...
excel_file_path = f"C:\\Users\\{username}\\MTN Group\\CIM Reports Hub - Documents\\Automation_Scripts\\Automated_Scripts.xlsm"
# excel_file_path = f"C:\\Users\\{username}\\MTN Group\\CIM Reports Hub - Documents\\Automation_Scripts\\Automated_ScriptsTry1.xlsm"
# excel_file_path = f"C:\Users\monitoring.server1\MTN Group\CIM Reports Hub - Documents\Automation_Scripts"

# Define the list of run times
run_times = ["00:17","02:17", "04:17","06:17" "08:17","10:17","14:17","18:17" ,"12:17", "16:17", "20:17","22:17"]
...
while True:
    ...
    current_time_minutes = get_minutes(current_time)
    next_run_time_minutes = get_minutes(next_run_time)

    # Handle midnight wrap-around (e.g. 23:55 → 00:10)
    time_until_next_run = next_run_time_minutes - current_time_minutes
    if time_until_next_run <= 0:
        time_until_next_run += 24 * 60  # add a full day in minutes
