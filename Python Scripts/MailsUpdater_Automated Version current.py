...
def updateInboxMails(InboxItems):
    ...
    start_date = '2026-01-05 23:00:00'
    end_date = '2026-01-06 09:00:00'
    ...
    try:
        try:
                ...
                try:
                    ...
                    subprocess.run(['python', r'C:\Users\monitoring.server1\QE GIT\Bayobab-Py-N-Dump\Gods_Eye_Final.py'])
                    # subprocess.run(['python', "Gods_Eye_Final.py"])
